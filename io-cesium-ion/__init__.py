...
__classes__ = [
    ...
    GetTokenOperator,
    ClearTokenOperator,
    ExportUploadOperator,
    ProgressOperator,
    ProgressProperty,
]

register_classes, unregister_classes = bpy.utils.register_classes_factory(__classes__)
...
def register():
    ...
    bpy.types.WindowManager.csm_progress = PointerProperty(type=ProgressProperty)
